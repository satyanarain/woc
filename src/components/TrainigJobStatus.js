...
this.setState({user_id:value.id});
           ...
           this.setState({ isLogin: false });
                  ...
                  }  else if (this.state.job_started_on === '' && this.state.taken==='Taken') {
                        alert(this.props.lang.TRAINING_JOB_ERROR);
                  }  else if (this.state.job_title === '' && this.state.taken==='Taken') {
                        alert(this.props.lang.TRAINING_JOB_TITLE_ERROR);
                  }  else if (this.state.job_income === '' && this.state.taken==='Taken') {
                        alert(this.props.lang.TRAINING_SALARY_ERROR);
                 }else{
...
{                                                 (taken==='Taken') ?
                       ...
                       dateText:{
                        // textAlign: 'left',
                         ...
                         //customStyles={customStyles}
                        ref='datepicker'
                         date={this.state.job_started_on}
                         mode="date"
                         ...
                         onDateChange={(date) => {this.setState({job_started_on: date})}}   />  
