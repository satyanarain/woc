...
class TraningCentresSubList extends React.Component {
...
componentWillMount(){
  ...
  ServiceClass.letSuggestedCenter(this.props.selectedLangCode,'get-training-center-list',this.props.id).then((reData) => {
    ...
    return (
       ...
       <View style={styles.MainContainer}>
             ...
             <View style={{ width: '100%' }}>
              <CustomHeader
              headerText={'Training Centres'}

              />
               </View>
                           <View style={styles.subcontainer}>
                                          <View style={styles.logo}>
                                              {/*<ResponsiveImage  source={require('../../assets/logo.png')}   initWidth="159" initHeight="73"/>*/}
                                           
             <ResponsiveImage
                                                      source={require('../../assets/logo.png')}
                                                        initWidth="164" initHeight="91" />
                                  ...
                                  <View style={{}}>
                                   ...
                                   <View>
                                        ...
                                        <ResponsiveImage
                                            ...
                                            <Text numberOfLines={1} style={styles.itemName}>  {item.district}</Text>
...
return { lang: data , selectedLangCode:selectedLangCode };
 ...
 export default connect(mapStateToProps,actions) (TraningCentresSubList);
